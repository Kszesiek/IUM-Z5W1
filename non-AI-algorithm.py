...
products_path = "../data/iteration_3/raw/products.jsonl"
sessions_path = "../data/iteration_3/raw/sessions.jsonl"
users_path = "../data/iteration_3/raw/users.jsonl"
...
sessions_data = pd.merge(sessions_data, products_data, on="product_id").drop(columns=['product_name', 'category_path']).sort_values(by=['timestamp'])
prev_purchase = {}
spending_factors = {}
buy_session_counter = {}
